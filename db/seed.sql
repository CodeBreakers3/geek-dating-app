...
VALUES ('Tanner.Francis11@gmail.com', '$2y$10$o.agZGzQMbecrkt13OOsI.yod6bG0Uz7tXccL9P61h6BrdpyeLMpm');

-- Create a fake user for Jared - Password = 'password'
INSERT INTO users (email, hash)
VALUES ('thejaredandersen@gmail.com','$2y$10$o.agZGzQMbecrkt13OOsI.yod6bG0Uz7tXccL9P61h6BrdpyeLMpm');

-- Create a fake user for Steven - Password = 'password'
INSERT INTO users (email, hash)
VALUES ('sn3541@gmail.com','$2y$10$o.agZGzQMbecrkt13OOsI.yod6bG0Uz7tXccL9P61h6BrdpyeLMpm');
...
-- add a chat to the chat table for the match between jared and steven - Steven says well hi to you too!
INSERT INTO chats (match_id, chat_content, user_id, time_stamp)
